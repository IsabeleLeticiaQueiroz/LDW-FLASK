...
def init_app(app):
    ...
    def estoque(id=None):
        ...
        if request.method == 'POST':
            ...
            #paginacao de registros
            #captura o valor de page q foi passado pelo metodo get
            page = request.args.get('page', 1, type=int)
            #definindo valor de registros por pagina
            per_page = 3
            # query.all é método do SQL Alchemy para selecionar todos os registros
            #query.paginate() é o método do SQL Alchemy para filtrar registros de acordo com o limite por página
            # ...existing code...
            page = request.args.get('page', 1, type=int)
            per_page = 3
